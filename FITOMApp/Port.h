...
public:
	...
	virtual int GetDesc(TCHAR* str) = 0;
};
...
public:
	...
	virtual void reset() { parent->reset(); };
	virtual int GetDesc(TCHAR* str) { return parent ? parent->GetDesc(str) : (str[0] = '\0'); };
};
