...
public:
	COPL(CPort* pt, UINT8 mode=0, UINT8 fsamp=0, UINT8 devtype=DEVICE_OPL);
...
public:
	C3801(CPort* pt, UINT8 mode = 0, UINT8 fsamp = 0, UINT8 devtype=DEVICE_Y8950);
};

class COPL2 : public COPL {
public:
	COPL2(CPort* pt, UINT8 mode = 0, UINT8 fsamp = 0, UINT8 devtype=DEVICE_OPL2);
};
...
protected:
	...
	static UINT8 opmap[];
public:
	COPL3(CPort* pt, UINT8 fsamp=2);
};

class COPL3_2 : public CSpanDevice {
public:
	COPL3_2(CPort* pt1, CPort* pt2, UINT8 mode = 0, UINT8 fsamp = 2, UINT8 devtype=DEVICE_OPL3_2);
};
