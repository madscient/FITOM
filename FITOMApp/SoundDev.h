...
public:
	...
	virtual void SetNote(UINT8 ch, UINT8 note, SINT16 fine, int update=1) = 0;
	...
	virtual void GetDescriptor(char* str) = 0;
...
public:
	CSoundDevice(UINT8 devid, UINT8 maxchs, UINT8 fsamp=0, CPort* pt=0);
	//CSoundDevice();
	~CSoundDevice();
	...
	virtual void SetNote(UINT8 ch, UINT8 note, SINT16 fine, int update=1);
	...
	virtual void GetDescriptor(char* str);
