...
COPN::COPN(CPort* pt, UINT8 fsamp, UINT8 devtype) :
	CSoundDevice(devtype, 3, fsamp & 3, pt)
{
	switch (fsamp>>2) {
	case 3:	// 1/6, 1/4
		SetReg(0x2f, 0, 1);
...
//-----
COPNC::COPNC(CPort* pt, UINT8 fsamp, UINT8 devtype) : COPN(pt, fsamp, devtype)
{
}
