...
CSplitPan::CSplitPan(CSoundDevice* chip1, CSoundDevice* chip2, UINT8 fsamp) : CUnison(chip1, chip2, fsamp)
{
}
...
CLinearPan::CLinearPan(CSoundDevice* chip1, CSoundDevice* chip2, UINT8 fsamp) : CUnison(chip1, chip2, fsamp)
{
}
