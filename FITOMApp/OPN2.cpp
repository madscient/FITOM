...
COPN2::COPN2(CPort* pt1, CPort* pt2, UINT8 fsamp, UINT8 devtype)
	: CSpanDevice(new COPN(pt1, fsamp, devtype), new COPN(pt2, fsamp & 3, devtype), fsamp & 3)
{
...
/*----------------*/
COPN2C::COPN2C(CPort* pt1, CPort* pt2, UINT8 fsamp, UINT8 devtype) : COPN2(pt1, pt2, fsamp, devtype)
{
}

/*----------------*/
COPN2L::COPN2L(CPort* pt1, CPort* pt2, UINT8 fsamp, UINT8 devtype) : COPN2(pt1, pt2, fsamp, devtype)
{
}

/*----------------*/

COPNA::COPNA(CPort* pt1, CPort* pt2, UINT8 fsamp, UINT8 devtype) : COPN2(pt1, pt2, fsamp, devtype)
{
...
/*----------------*/
COPNB::COPNB(CPort* pt1, CPort* pt2, UINT8 fsamp, UINT8 devtype) : COPN2(pt1, pt2, fsamp, devtype)
{
	EnableCh(0, 0);
	EnableCh(3, 0);
}
...
/*----------------*/
CF286::CF286(CPort* pt1, CPort* pt2, UINT8 fsamp, UINT8 devtype) : COPNB(pt1, pt2, fsamp, devtype)
{
}

/*----------------*/
C2610B::C2610B(CPort* pt1, CPort* pt2, UINT8 fsamp, UINT8 devtype) : COPNB(pt1, pt2, fsamp, devtype)
{
	EnableCh(0, 1);
	EnableCh(3, 1);
}
...
/*----------------*/
COPN3L::COPN3L(CPort* pt1, CPort* pt2, UINT8 fsamp, UINT8 devtype) : COPNA(pt1, pt2, fsamp & 0xc, devtype)
{
	SetReg(0x20, 0x02, 1);
}
