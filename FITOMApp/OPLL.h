...
public:
	COPLL(CPort* pt, UINT8 mode=0, UINT8 fsamp=2, UINT8 devtype=DEVICE_OPLL);
...
public:
	COPLLP(CPort* pt, UINT8 mode = 0, UINT8 fsamp = 2, UINT8 devtype = DEVICE_OPLLP);
};

class COPLLX : public COPLL {
public:
	COPLLX(CPort* pt, UINT8 mode = 0, UINT8 fsamp = 2, UINT8 devtype = DEVICE_OPLLX);
};
...
protected:
	virtual void UpdateFreq(UINT8 ch, const FNUM* fnum);
public:
	COPLL2(CPort* pt, UINT8 mode = 0, UINT8 fsamp = 2, UINT8 devtype = DEVICE_OPLL2);
};
