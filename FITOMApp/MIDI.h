...
public:
	...
	//Channel Monitor
	virtual UINT8 GetDeviceID() const { return 0xff; };
...
public:
	...
	//Monitor
	virtual UINT8 GetDeviceID() const;
	...
	virtual UINT16 GetBankNo() const { return BankSelect; };
...
public:
	...
	void Assign(UINT8 nch, CSoundDevice* dev, UINT8 pol);
