...
public:
	...
	CMultiDevice(CSoundDevice* chip1, CSoundDevice* chip2, UINT8 fsamp);
...
public:
	CSpanDevice(CSoundDevice* chip1, CSoundDevice* chips, UINT8 fsamp);
	//CSpanDevice();
...
protected:
	...
	virtual void UpdateFnumber(UINT8 ch, int update=1);
public:
	CUnison(CSoundDevice* chip1, CSoundDevice* chips, UINT8 fsamp);
...
protected:
	...
	virtual void UpdateKey(UINT8 ch, UINT8 keyon);
public:
	CSplitPan(CSoundDevice* chip1, CSoundDevice* chips, UINT8 fsamp);
};
...
protected:
	...
	virtual void UpdateVolExp(UINT8 ch);
public:
	CLinearPan(CSoundDevice* chip1, CSoundDevice* chips, UINT8 fsamp);
	virtual void SetVolume(UINT8 ch, UINT8 vol, int update=1);
};
