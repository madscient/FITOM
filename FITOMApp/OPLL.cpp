...
COPLL::COPLL(CPort* pt, UINT8 mode, UINT8 fsamp, UINT8 devtype) :
...
COPLLP::COPLLP(CPort* pt, UINT8 mode, UINT8 fsamp, UINT8 devtype) : COPLL(pt, mode, fsamp, devtype)
{
}

COPLLX::COPLLX(CPort* pt, UINT8 mode, UINT8 fsamp, UINT8 devtype) : COPLL(pt, mode, fsamp, devtype)
{
}

COPLL2::COPLL2(CPort* pt, UINT8 mode, UINT8 fsamp, UINT8 devtype) : COPLL(pt, mode, fsamp, devtype)
{
}
